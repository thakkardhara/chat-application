...
const MsgSingle = () => {
  ...
  <div className='chat-image avatar'>
      ...
      <div className={`chat-bubble text-white bg-red-400`}>Hi! i am dhara Thakkar</div>
      <div className="chat-footer opacity-50 text-xs flex gap-1 items-center">11:05</div>
      </div>
  </>
  )
}
